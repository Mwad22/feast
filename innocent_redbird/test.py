...
import pandas as pd
from driver_repo import driver, driver_stats_fv, driver_monthly_fv
...
def main():
    ...
    fs.apply([driver, driver_stats_fv, driver_monthly_fv])

    # Select features
    feature_refs = ["driver_hourly_stats:conv_rate", "driver_hourly_stats:acc_rate",  "driver_monthly_stats:avg_daily_trips"]
    ...
    training_df = fs.get_historical_features(
        feature_refs=feature_refs, entity_df=entity_df, feature_names_only=False
    ).to_df()
